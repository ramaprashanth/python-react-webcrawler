...
All credits go to the facebookincubator team.  

Below you will find some information on how to perform common tasks.  
You can find the most recent version of this guide [here](https://github.com/facebookincubator/create-react-app/blob/master/template/README.md).

![](http://i.giphy.com/tVoWNvJyP4B3y.gif)
...
Then install all project dependencies with `npm install`, when you're in the project folder.

At last, run the project with `npm start`.
...
The weatherRoutes.js file will contain all the routes that the page can link to.
You can change these in order for the app to travel to which ever component you'd like to travel to.
